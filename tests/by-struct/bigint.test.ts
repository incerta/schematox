...
describe('Type inference and parse by schema/construct/struct (foldA)', () => {
  it('required', () => {
    ...
    const struct = x.bigint()

    type ExpectedSubj = bigint

    const subjects: Array<ExpectedSubj> = fixture.DATA_VARIANTS_BY_TYPE.bigint
  ...
  it('optional', () => {
    ...
    const struct = x.bigint().optional()

    type ExpectedSubj = bigint | undefined

    const subjects: Array<ExpectedSubj> = [
      ...fixture.DATA_VARIANTS_BY_TYPE.bigint,
      undefined,
    ]
  ...
  it('nullable', () => {
    ...
    const struct = x.bigint().nullable()

    type ExpectedSubj = bigint | null
  ...
  it('optional + nullable + min + max ', () => {
    ...
    type ExpectedSubj = bigint | undefined | null
...
describe('Struct parameter keys reduction and schema immutability (foldB)', () => {
  it('optional', () => {
    ...
    const prevStruct = x.bigint()
    const struct = prevStruct.optional()

    type ExpectedKeys =
      StructSharedKeys | 'brand' | 'description' | 'max' | 'min' | 'nullable'
  ...
  it('optional + nullable', () => {
    ...
    type ExpectedKeys =
      StructSharedKeys | 'brand' | 'description' | 'max' | 'min'
...
describe('ERROR_CODE.invalidType (foldC)', () => {
  ...
  it('iterate over fixture.DATA_TYPE', () => {
    const schema = { type: 'bigint' } satisfies x.Schema
    const struct = x.bigint()
